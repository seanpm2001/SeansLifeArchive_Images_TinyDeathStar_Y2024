...
- **Imperial credits:** `~54,880` <!-- An estimate, as the amount can go up between the time of the last screenshot, and the game closing !-->
- **Imperial Bux:** `474`
- **In-game spending**
- - **iBux (spent):** `~790+`
- - **iBux (kept):** `474`
- - **iBux (all):** `~1,264+`
- - **iCredits (spent):** `at least 16,700,000`
- - **iCredits (kept):** `~469,266`
- - **iCredits (all):** `at least ~16,754,880`
...
- **Security systems:** `660` (goal: 10 Security Systems for every 1 level)
- **Diplomatic envoys:** `265`
- **Comlinks:** `187`
- **Internal forcefields:** `104`
- **Inspections:** `80`
- **Shield projectors:** `112`
- **Imperial Edict:** `34`
...
- **File version:** `1 (2024, Wednesday, November 6th at 02:48 pm PST)`
