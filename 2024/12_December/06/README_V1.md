...
- **Imperial credits:** `~44,044` <!-- An estimate, as the amount can go up between the time of the last screenshot, and the game closing !-->
- **Imperial Bux:** `521`
- **In-game spending**
- - **iBux (spent):** `~798+`
- - **iBux (kept):** `529`
- - **iBux (all):** `~1,308+`
- - **iCredits (spent):** `at least 18,400,000`
- - **iCredits (kept):** `~44,044`
- - **iCredits (all):** `at least ~18,444,044`
...
- **Security systems:** `688` (goal: 10 Security Systems for every 1 level)
- **Diplomatic envoys:** `280`
- **Comlinks:** `195`
- **Internal forcefields:** `112`
- **Inspections:** `88`
- **Shield projectors:** `122`
- **Imperial Edict:** `42`
- **Total materials:** `1,527`
...
- **File version:** `1 (2024, Wednesday, December 25th at 02:35 pm PST)`
