...
- **Imperial credits:** `~425,735` <!-- An estimate, as the amount can go up between the time of the last screenshot, and the game closing !-->
- **Imperial Bux:** `496`
- **In-game spending**
- - **iBux (spent):** `~790+`
- - **iBux (kept):** `496`
- - **iBux (all):** `~1,286+`
- - **iCredits (spent):** `at least 16,710,000`
- - **iCredits (kept):** `~425,735`
- - **iCredits (all):** `at least ~17,335,735`
...
- **Security systems:** `666` (goal: 10 Security Systems for every 1 level)
- **Diplomatic envoys:** `268`
- **Comlinks:** `189`
- **Internal forcefields:** `106`
- **Inspections:** `82`
- **Shield projectors:** `115`
- **Imperial Edict:** `36`
- **Total materials:** `1,462`
...
- **File version:** `1 (2024, Wednesday, November 6th at 02:53 pm PST)`
