...
- **Imperial credits:** `~305,108` <!-- An estimate, as the amount can go up between the time of the last screenshot, and the game closing !-->
- **Imperial Bux:** `516`
- **In-game spending**
- - **iBux (spent):** `~790+`
- - **iBux (kept):** `516`
- - **iBux (all):** `~1,295+`
- - **iCredits (spent):** `at least 17,550,000`
- - **iCredits (kept):** `~305,108`
- - **iCredits (all):** `at least ~17,855,108`
...
- **Security systems:** `677` (goal: 10 Security Systems for every 1 level)
- **Diplomatic envoys:** `274`
- **Comlinks:** `192`
- **Internal forcefields:** `109`
- **Inspections:** `85`
- **Shield projectors:** `119`
- **Imperial Edict:** `36`
- **Total materials:** `1,492`
...
- **File version:** `1 (2024, Friday, November 15th at 05:07 pm PST)`
