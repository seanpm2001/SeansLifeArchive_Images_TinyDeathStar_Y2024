...
- **Imperial credits:** `~546,725` <!-- An estimate, as the amount can go up between the time of the last screenshot, and the game closing !-->
- **Imperial Bux:** `521`
- **In-game spending**
- - **iBux (spent):** `~790+`
- - **iBux (kept):** `521`
- - **iBux (all):** `~1,300+`
- - **iCredits (spent):** `at least 17,560,000`
- - **iCredits (kept):** `~546,625`
- - **iCredits (all):** `at least ~18,106,625`
...
- **Security systems:** `680` (goal: 10 Security Systems for every 1 level)
- **Diplomatic envoys:** `276`
- **Comlinks:** `193`
- **Internal forcefields:** `110`
- **Inspections:** `86`
- **Shield projectors:** `120`
- **Imperial Edict:** `40`
- **Total materials:** `1,505`
...
- **File version:** `1 (2024, Friday, November 22nd at 07:55 pm PST)`
